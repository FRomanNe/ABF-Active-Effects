...
const calculateWeaponBreaking = (weapon, data) => {
  ...
  let breaking = weapon.system.breaking.base.value + weapon.system.breaking.mod.value + getWeaponBreakingFromStrength(strength) + Math.floor(weapon.system.quality.value / 5 * 2);
